  ...
  <body style="background-color: #fef3c7; font-family: sans-serif; color: #333333; padding: 24px;">
    <div style="max-width: 500px; margin: 0 auto; background-color: white; border-radius: 16px; border: 1px solid #d1d5db; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); padding: 24px;">
      ...
      <div style="text-align: center; margin-bottom: 16px;">
        <img src='LogoCorreo.png' alt='Logo Ludicamente' style='width: 100%; height: 112px; object-fit: contain;' />
      </div>

      <!-- Texto de saludo -->
      <h2 style="font-size: 20px; font-weight: 600; margin-bottom: 8px;">¡Hola " + nombre + "!</h2>
      ...
      <!-- Imagen central -->
      <div style="text-align: center; margin-bottom: 16px;">
        <img src='ImgCorreo.jpeg' alt='Imagen Ludicamente' style='width: 100%; border-radius: 12px;' />
      </div>

      <!-- Botón CTA -->
      <div style="text-align: center; margin-bottom: 24px;">
        <a href="https://www.ludicamente.com" style="background-color: #cd7e4e; color: #fff8dc; padding: 12px 24px; border-radius: 9999px; font-size: 14px; font-weight: 600; text-decoration: none; display: inline-block;">
